    ...
    while not finished:
        ...
        if len(task.yields) > 0:
            ...
            if flag == 'finish':
                ...
                # delete Capsule temp images, only keep gradio temp images
...
title = f'Capsule {capsule_version.version}'
            ...
            with gr.Row(visible=modules.config.default_image_prompt_checkbox) as image_input_panel:
                with gr.Tabs(selected=modules.config.default_selected_image_input_tab_id):
                    ...
                    with gr.Tab(label='Metadata', id='metadata_tab') as metadata_tab:
                        with gr.Column():
                            metadata_input_image = grh.Image(label='For images created by Capsule', source='upload', type='pil')
                        ...
                        with gr.Tab(label=f'#{index + 1}') as enhance_tab_item:
                            ...
                            with gr.Accordion("Inpaint", visible=True, open=False):
                                ...
                                enhance_inpaint_engine = gr.Dropdown(label='Inpaint Engine',
                                                                     ...
                                                                     info='Version of Capsule inpaint model. If set, use performance Quality or Speed (no performance LoRAs) for best results.')
                ...
                with gr.Column(visible=modules.config.default_developer_debug_mode_checkbox) as dev_tools:
                    with gr.Tab(label='Debug Tools'):
                        ...
                        adaptive_cfg = gr.Slider(label='CFG Mimicking from TSNR', minimum=1.0, maximum=30.0, step=0.01,
                                                 ...
                                                 info='Enabling Capsule\'s implementation of CFG mimicking for TSNR '
